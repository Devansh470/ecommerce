    ...
    return(
        ...
        <div style={{ backgroundColor:"rgb(253, 234, 238)",paddingBottom:"20px"}}>
            ...
            <div style={{display:"flex", margin:"10px 0px 0px 150px"}}>
                <img src="/image/service3.jpg" alt="" style={{margin:"20px"}}/>
                <img src="/image/service2.jpg" alt="" style={{margin:"20px"}}/>
                <img src="/image/service1.jpg" alt="" style={{margin:"20px"}}/>
            </div>
        </div>
        </div>
        <div style={{margin:"70px 0px 70px 330px"}}>
        ...
        <div style={{ backgroundColor:"rgb(253, 234, 238)",paddingBottom:"20px"}}>
            <div>
            <div style={{textAlign:"center", width:"900px", fontSize:"40px", fontFamily:"Bahnschrift SemiBold SemiConden", margin:"0px 0px 0px 330px", paddingTop:"20px"}} > <b> Less Carbon. More Comfort.</b></div>
            <div style={{display:"flex", margin:"10px 0px 0px 100px"}}>
                <img src="/image/service4.jpg" alt="" style={{margin:"20px", width:"400px", height:"450px"}}/>
                <img src="/image/service5.jpg" alt="" style={{margin:"20px", width:"400px", height:"450px"}}/>
                <img src="/image/service6.jpg" alt="" style={{margin:"20px", width:"400px", height:"450px"}}/>
            </div>
        </div>
        </div>
        <div style={{margin:"70px 0px 70px 330px"}}>
