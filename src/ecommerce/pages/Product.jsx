    ...
    <div id="shoppage">
            <div style={{width:"550px", paddingLeft:"20px",paddingTop:"100px", backgroundColor:"rgb(253, 234, 238)"}}>       
             <div style={{fontFamily:"Bahnschrift SemiBold SemiConden", fontSize:"30px"}}> Search By Category </div>
              ...
              <input type="radio" value="men" name="cat" onChange={(e)=>{setCatData(e.target.value)}} /> Mens footwear
              <br/>
              <input type="radio" value="women" name="cat"  onChange={(e)=>{setCatData(e.target.value)}} /> Womens footwear
              <br/>
              <input type="radio" value="kids" name="cat"  onChange={(e)=>{setCatData(e.target.value)}} /> Kids footwear
             <br/>
             </div>
