...
const Sale=()=>{
    ...
    <h4 style={{color:"red", fontSize:"16px"}}>  Price : <span style={{textDecoration:"line-through", marginRight:"10px"}}>{key.price} </span> <span style={{color:"green", fontSize:"18px"}}> {offerPrice}</span></h4> 
